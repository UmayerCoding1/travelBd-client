...
const About = () => { 
    return (
        <div className='lg:flex gap-2 '>
           <div className='w-full h-[50vh] lg:h-[70vh] lg:w-1/2 relative hidden lg:block'>
           ...
           <div className='lg:w-1/2 mt-10 lg:mt-0'>
              ...
              <div className='grid grid-cols-2 gap-2 lg:grid-cols-3 mt-5 lg:mt-10'>
                <div data-aos="flip-up" className='bg-[#E7E7E7] w-40 h-20 flex flex-col items-center justify-center rounded-lg hover:shadow-lg'>
                    <h2 className='text-3xl font-semibold'><NumberCount target={571} duration={1000}/></h2>
                    <p>our explorers</p>
                </div>

                <div data-aos="flip-up" className='bg-[#E7E7E7] w-40 h-20 flex flex-col items-center justify-center rounded-lg hover:shadow-lg'>
                    <h2 className='text-3xl font-semibold'><NumberCount target={100} duration={1000}/></h2>
                    <p>Destination</p>
                </div>
                ...
                <h2 className='text-3xl font-semibold'><NumberCount target={5} duration={1000}/></h2>
